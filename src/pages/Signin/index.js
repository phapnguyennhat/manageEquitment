    ...
    <div className={cx("signWrapper")}>
      <div className={cx("signIn")}>
        <div className={cx("signIn_left")}>
          <img
            alt=""
            src="https://brownandcaldwell.com/wp-content/uploads/2022/09/NEA-Template_1080x1080-cover-e1663009946143.png"
          ></img>
        </div>
        <div className={cx("signIn_right")}>
          <div className={cx("signIn_right_content")}>
            <Link to="/">
              <i
                className={cx("fa fa-close", "signIn_close")}
                aria-hidden="true"
              ></i>
            </Link>
            <h3>ĐĂNG NHẬP</h3>
            ...
            <div className={cx("signIn_right_button")}>
              <div className={cx("continue")}>
                ...
                <i>
                  <i
                    className={cx("fa fa-angle-right", "above")}
                    aria-hidden="true"
                  ></i>
                </i>
              </div>
